...
const services = [
  ...
  },
  {
    ...
    price: "₹5,000+",
    description:
      "Professional responsive website. Price depends on the number of pages and requirements.",
  ...
  },
  {
    ...
    price: "₹10,000 – ₹25,000",
    description:
      "Complete e-commerce website with features based on your business requirements.",
  ...
  },
  {
    ...
    price: "₹3,000+ / month",
    description:
      "Monthly SEO based on your website's current status, competition and requirements.",
    href: "/services/seo",
  },
  {
    icon: <FaFacebookF />,
    ...
    price: "₹3,000+ / month",
    description:
      "Facebook & Instagram advertising management. Ad budget is separate.",
  ...
  },
  {
    ...
    price: "₹4,000+ / month",
    description:
      "Sales and lead-focused advertising campaigns. Ad budget is separate.",
    href: "/services/lead-generation-ads",
  },
  {
    icon: <FaWhatsapp />,
    ...
    price: "₹1,000",
    description:
      "WhatsApp marketing setup and management. Customer's campaign/message budget is separate.",
  ...
  },
  {
    ...
    price: "₹400+ / video",
    description:
      "Professional video editing for reels, social media and business content.",
  ...
  },
  {
    ...
    price: "₹600+ / video",
    description:
      "AI-powered videos for marketing, promotions and social media.",
    href: "/services/video-editing",
  },
  {
    icon: <FaPalette />,
    ...
    price: "₹300 – ₹800",
    description:
      "Professional logo design based on your brand and requirements.",
  ...
  },
  {
    ...
    price: "₹300 – ₹800",
    description:
      "Creative promotional flyer design for your business or event.",
    href: "/services/graphic-design",
  },
  {
    icon: <FaBookOpen />,
    ...
    price: "₹300 – ₹800",
    description:
      "Professional catalogue design to showcase your products and services.",
    href: "/services/graphic-design",
  },
];
    ...
    <section className="w-full px-6 md:px-10 lg:px-[8%] py-14">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
        {services.map((service, index) => (
          ...
          >
            <div className="group h-full cursor-pointer rounded-2xl border border-gray-200 bg-white p-5 hover:border-red-200 hover:shadow-[0_8px_25px_rgba(0,0,0,0.06)] transition-all duration-300">
              ...
              {/* Description */}
              <p className="mt-3 text-sm text-gray-500 dark:text-gray-300 leading-6">
                {service.description}
              </p>
            </div>
          </Link>
